...
object CsvTableSource {
  ...
  class Builder {
    ...
    private val fieldNames: ListBuffer[String] = mutable.ListBuffer[String]()
    private val fieldTypes: ListBuffer[TypeInformation[_]] = mutable.ListBuffer[TypeInformation[_]]()
